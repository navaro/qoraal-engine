...
static const QORAAL_CFG_T       _qoraal_cfg = { .malloc = platform_malloc, .free = platform_free, .print = platform_print, .getch = platform_getch, .debug_assert = platform_assert, .current_time = platform_current_time, .rand = platform_rand, .wdt_kick = platform_wdt_kick};
